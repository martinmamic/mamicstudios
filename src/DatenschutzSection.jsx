...
const DatenschutzSection = () => (
  <section id="datenschutz" className="relative min-h-screen text-white flex flex-col justify-center items-center py-20 sm:py-28 px-4 sm:px-6 lg:px-8" style={{ background: '#18181b' }}>
